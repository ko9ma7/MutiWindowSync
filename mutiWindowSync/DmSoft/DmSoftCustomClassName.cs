...
namespace mutiWindowSync.DmSoft
{
    public class DmSoftCustomClassName
    {
        ...
        public string FindPicEx(int x1, int y1, int x2, int y2, string pic_name, string delta_color, double sim,
            int dir)
        {
        ...
        public int GetWordResultPos(string str, int index, out int x, out int y)
        {
            ...
            result = obj.InvokeMember("GetWordResultPos", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[2];
            y = (int)args[3];
            return (int)result;
        ...
        public string FindStrWithFontEx(int x1, int y1, int x2, int y2, string str, string color, double sim,
            string font_name, int font_size, int flag)
        {
        ...
        public int FindPic(int x1, int y1, int x2, int y2, string pic_name, string delta_color, double sim, int dir,
            out int x, out int y)
        {
            object[] args = new object[10];
            object result;
        ...
        public string FindPicMemE(int x1, int y1, int x2, int y2, string pic_info, string delta_color, double sim,
            int dir)
        {
            object[] args = new object[8];
            object result;
        ...
        public int GetScreenDataBmp(int x1, int y1, int x2, int y2, out int data, out int size)
        {
            ...
            result = obj.InvokeMember("GetScreenDataBmp", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            data = (int)args[4];
            size = (int)args[5];
            return (int)result;
        ...
        public string FindMultiColorEx(int x1, int y1, int x2, int y2, string first_color, string offset_color,
            double sim, int dir)
        {
            object[] args = new object[8];
            object result;
        ...
        public int GetResultPos(string str, int index, out int x, out int y)
        {
            ...
            result = obj.InvokeMember("GetResultPos", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[2];
            y = (int)args[3];
            return (int)result;
        ...
        public int FindPicMem(int x1, int y1, int x2, int y2, string pic_info, string delta_color, double sim, int dir,
            out int x, out int y)
        {
            object[] args = new object[10];
            object result;
            ...
            result = obj.InvokeMember("FindPicMem", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[8];
            y = (int)args[9];
            return (int)result;
        ...
        public string FindDoubleEx(int hwnd, string addr_range, double double_value_min, double double_value_max,
            int steps, int multi_thread, int mode)
        {
            object[] args = new object[7];
            object result;
            args[0] = hwnd;
        ...
        public int FindStrWithFont(int x1, int y1, int x2, int y2, string str, string color, double sim,
            string font_name, int font_size, int flag, out int x, out int y)
        {
            ...
            result = obj.InvokeMember("FindStrWithFont", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[10];
            y = (int)args[11];
            return (int)result;
        ...
        public string FindPicSimMemEx(int x1, int y1, int x2, int y2, string pic_info, string delta_color, int sim,
            int dir)
        {
            object[] args = new object[8];
            object result;
        ...
        public string FindPicS(int x1, int y1, int x2, int y2, string pic_name, string delta_color, double sim, int dir,
            out int x, out int y)
        {
            object[] args = new object[10];
            object result;
        ...
        public string FindIntEx(int hwnd, string addr_range, long int_value_min, long int_value_max, int tpe, int steps,
            int multi_thread, int mode)
        {
            object[] args = new object[8];
            object result;
            args[0] = hwnd;
        ...
        public string FindPicSimEx(int x1, int y1, int x2, int y2, string pic_name, string delta_color, int sim,
            int dir)
        {
            object[] args = new object[8];
            object result;
        ...
        public string FindStrFastS(int x1, int y1, int x2, int y2, string str, string color, double sim, out int x,
            out int y)
        {
            object[] args = new object[9];
            object result;
            ...
            result = obj.InvokeMember("FindStrFastS", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[7];
            y = (int)args[8];
            return result.ToString();
        ...
        public int FindColorBlock(int x1, int y1, int x2, int y2, string color, double sim, int count, int width,
            int height, out int x, out int y)
        {
            ...
            result = obj.InvokeMember("FindColorBlock", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[9];
            y = (int)args[10];
            return (int)result;
        ...
        public int GetClientSize(int hwnd, out int width, out int height)
        {
            ...
            result = obj.InvokeMember("GetClientSize", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            width = (int)args[1];
            height = (int)args[2];
            return (int)result;
        ...
        public int FindStrFast(int x1, int y1, int x2, int y2, string str, string color, double sim, out int x,
            out int y)
        {
            object[] args = new object[9];
            object result;
            ...
            result = obj.InvokeMember("FindStrFast", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[7];
            y = (int)args[8];
            return (int)result;
        ...
        public string FindPicExS(int x1, int y1, int x2, int y2, string pic_name, string delta_color, double sim,
            int dir)
        {
            object[] args = new object[8];
            object result;
        ...
        public string FindStrWithFontE(int x1, int y1, int x2, int y2, string str, string color, double sim,
            string font_name, int font_size, int flag)
        {
            object[] args = new object[10];
            object result;
        ...
        public string FindMultiColorE(int x1, int y1, int x2, int y2, string first_color, string offset_color,
            double sim, int dir)
        {
            object[] args = new object[8];
            object result;
        ...
        public int FindPicSimMem(int x1, int y1, int x2, int y2, string pic_info, string delta_color, int sim, int dir,
            out int x, out int y)
        {
            object[] args = new object[10];
            object result;
            ...
            result = obj.InvokeMember("FindPicSimMem", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[8];
            y = (int)args[9];
            return (int)result;
        ...
        public int FindPicSim(int x1, int y1, int x2, int y2, string pic_name, string delta_color, int sim, int dir,
            out int x, out int y)
        {
            object[] args = new object[10];
            object result;
            ...
            result = obj.InvokeMember("FindPicSim", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[8];
            y = (int)args[9];
            return (int)result;
        ...
        public int FindMultiColor(int x1, int y1, int x2, int y2, string first_color, string offset_color, double sim,
            int dir, out int x, out int y)
        {
            object[] args = new object[10];
            object result;
            ParameterModifier[] mods = new ParameterModifier[1];
            ...
            result = obj.InvokeMember("FindMultiColor", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[8];
            y = (int)args[9];
            return (int)result;
        ...
        public string FindColorBlockEx(int x1, int y1, int x2, int y2, string color, double sim, int count, int width,
            int height)
        {
            object[] args = new object[9];
            object result;
        ...
        public string FindPicMemEx(int x1, int y1, int x2, int y2, string pic_info, string delta_color, double sim,
            int dir)
        {
            object[] args = new object[8];
            object result;
        ...
        public int GetCursorPos(out int x, out int y)
        {
            ...
            result = obj.InvokeMember("GetCursorPos", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x = (int)args[0];
            y = (int)args[1];
            return (int)result;
        ...
        public string FindStrS(int x1, int y1, int x2, int y2, string str, string color, double sim, out int x,
            out int y)
        {
            object[] args = new object[9];
            object result;
        ...
        public string FindFloatEx(int hwnd, string addr_range, float float_value_min, float float_value_max, int steps,
            int multi_thread, int mode)
        {
            object[] args = new object[7];
            object result;
        ...
        public int GetWindowRect(int hwnd, out int x1, out int y1, out int x2, out int y2)
        {
            ...
            result = obj.InvokeMember("GetWindowRect", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x1 = (int)args[1];
            y1 = (int)args[2];
            x2 = (int)args[3];
        ...
        public string FindPicSimMemE(int x1, int y1, int x2, int y2, string pic_info, string delta_color, int sim,
            int dir)
        {
            object[] args = new object[8];
            object result;
        ...
        public int FindShape(int x1, int y1, int x2, int y2, string offset_color, double sim, int dir, out int x,
            out int y)
        {
            object[] args = new object[9];
            object result;
        ...
        public int GetClientRect(int hwnd, out int x1, out int y1, out int x2, out int y2)
        {
            ...
            result = obj.InvokeMember("GetClientRect", BindingFlags.InvokeMethod, null, obj_object, args, mods, null,
                null);
            x1 = (int)args[1];
            y1 = (int)args[2];
            x2 = (int)args[3];
        ...
        public string FindStringEx(int hwnd, string addr_range, string string_value, int tpe, int steps,
            int multi_thread, int mode)
        {
            object[] args = new object[7];
            object result;
